namespace DuringTravelAPI.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DuringTravelAPI.Models.DuringTravelAPIContext>
    {
        ...
        protected override void Seed(DuringTravelAPI.Models.DuringTravelAPIContext context)
        {
            ...
            context.BookingAgencies.AddOrUpdate(b => b.BookingAgencyId,
                new BookingAgency { BookingAgencyId = 1, bookingAgencyName = "Funjet Vacations" },
                new BookingAgency { BookingAgencyId = 2, bookingAgencyName = "Southwest Vacations" },
                new BookingAgency { BookingAgencyId = 3, bookingAgencyName = "United Vacations" }
